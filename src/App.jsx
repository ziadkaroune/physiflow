...
function App() {
  ...
  function showAnimation(){
    ...
    if(inputAnimationT.toLowerCase() === "two balls of different masses collide on a frictionless surface"){
        setSelectAnimationT("MouvementBalls");
          setSuggestion(false);
    }
    else{
      setSelectAnimationT('');
      ...
      <div className='text-sm mt-6'>
        ...
        <div className='w-1/2  h-[80vh] flex justify-center items-center'>
              ...
              <div className='w-[400px] h-[400px] bg-black rounded-lg flex items-center justify-center'>
                {animationComponents[selectanimationT] || ( <p className='w-2/3'>{messgnotfound}</p> )}
              </div>
